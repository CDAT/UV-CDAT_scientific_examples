# 
# This python script plots climatologyt of JJA precipitation obtained from one single CMIP5 model
#
...
# load variable
#
d = f('pr',longitude=(-180,180))*86400.
d.units='mm/day'
...
# Color setup
#
levs = [3, 6, 9, 12, 15, 18, 21, 24, 27, 30]
iso.levels = levs
iso.ext_2 ="y"
